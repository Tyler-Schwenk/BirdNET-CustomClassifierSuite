...
def main():
    ...
    ap.add_argument("--stage", help="Filter experiments starting with this prefix (e.g. 'stage4_'). Leave empty to include all experiments.")
    ap.add_argument("--precision-floor", type=float, default=None, help="Precision floor for filtering.")
    ap.add_argument("--metric-prefix", default="metrics.ood.best_f1", help="Metric group prefix.")
